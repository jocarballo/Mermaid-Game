class MermaidGame {
  ...
  updateGameStatus() { // NÃO DEVIA TER AQUI UPDATE DA MERMAID?
    this.updateSharksPosition();
    this.updateTreasuresPosition();
    this.updateCollision();
    this.removingInvalidTreasures();
    this.removingInvalidSharks();
  }
}
